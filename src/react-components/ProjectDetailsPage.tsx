...
export function ProjectDetailsPage(props: Props) {
  ...
  if (!routeParams.id) {
    return <p>Project ID is needed to show project details</p>;
  }
  ...
  // Obtener las dos primeras letras del nombre del proyecto en mayúsculas
      ...
      <div className="main-page-content">
        <div style={{ display: "flex", flexDirection: "column", rowGap: 30 }}>
          <div className="dashboard-card" style={{ padding: "30px 0" }}>
            ...
            >
              {/* Utilizar las dos primeras letras del nombre del proyecto en mayúsculas */}
              <p
                style={{
                  fontSize: 20,
